...
namespace LeYMCL.Main.Views.Initialize;
...
public partial class InitializeWindow : Window
{
    ...
    private void Init()
    {
        ...
        {
            var resourceName = "LeYMCL.Main.Public.Texts.CustomHomePageDefault.axaml";
    ...
    {
        LeYMCL.Main.Views.Initialize.Pages.Main.Main mianPage = new();
