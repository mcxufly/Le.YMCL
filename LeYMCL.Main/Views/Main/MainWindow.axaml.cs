...
using LeYMCL.Main.Public.Controls;
using LeYMCL.Main.Public.Langs;
using LeYMCL.Main.Views.Main.Pages.Download;
using LeYMCL.Main.Views.Main.Pages.Launch;
using LeYMCL.Main.Views.Main.Pages.More;
using LeYMCL.Main.Views.Main.Pages.Music;
using LeYMCL.Main.Views.Main.Pages.Search;
using LeYMCL.Main.Views.Main.Pages.Setting;
using LeYMCL.Main.Views.Main.Pages.TaskCenter;
using static LeYMCL.Main.Public.Classes.PlaySongListViewItemEntry;
using Brushes = System.Drawing.Brushes;
using FileInfo = LeYMCL.Main.Public.Classes.FileInfo;

namespace LeYMCL.Main.Views.Main;
