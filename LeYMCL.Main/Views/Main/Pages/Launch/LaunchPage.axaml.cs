...
using AccountType = LeYMCL.Main.Public.AccountType;
using SearchOption = System.IO.SearchOption;

namespace LeYMCL.Main.Views.Main.Pages.Launch;
        ...
        vlist.Add(new GameListEntry()
        {
            Id = MainLang.BedRockVersion, Type = "BedRock", Version = MainLang.IfInstallBedRock, Icon =
                Method.IO.LoadBitmapFromAppFile(
                    "LeYMCL.Main.Public.Assets.McIcons.dirt_path_side.png"),
            Entry = new GameEntry()
            ...
            icon = version.MainLoaderType switch
            {
                LoaderType.Vanilla => version.Type switch
                {
                    "release" => Method.IO.LoadBitmapFromAppFile(
                        "LeYMCL.Main.Public.Assets.McIcons.grass_block_side.png"),
                    "snapshot" => Method.IO.LoadBitmapFromAppFile(
                        "LeYMCL.Main.Public.Assets.McIcons.crafting_table_front.png"),
                    _ => icon
                },
                LoaderType.Forge =>
                    Method.IO.LoadBitmapFromAppFile("LeYMCL.Main.Public.Assets.McIcons.furnace_front.png"),
                LoaderType.OptiFine => Method.IO.LoadBitmapFromAppFile(
                    "LeYMCL.Main.Public.Assets.McIcons.OptiFineIcon.png"),
                LoaderType.Fabric => Method.IO.LoadBitmapFromAppFile("LeYMCL.Main.Public.Assets.McIcons.FabricIcon.png"),
                LoaderType.Quilt => Method.IO.LoadBitmapFromAppFile("LeYMCL.Main.Public.Assets.McIcons.QuiltIcon.png"),
                _ => Method.IO.LoadBitmapFromAppFile("LeYMCL.Main.Public.Assets.McIcons.grass_block_side.png")
            };
